 ...
 * cron: 0 * * * *
 *
 * https://www.po18.tw/panel/stock_manage/stocks 我的书柜
 *
 * 环境变量: PO18, 值: {"proxy": true, "bark": "zhangsan", "cookie": ""}
 */
const $ = new Env('PO18臉紅心跳');
const ENV = 'PO18';
...
!(async () => {
    ...
    await axios.get(`${host}/panel/stock_manage/stocks`, config).then(async (resp) => {
        ...
        for (const tr of root.querySelectorAll('tbody tr')) {
            ...
            const lastPost = tr.querySelector('.T_latest a');
